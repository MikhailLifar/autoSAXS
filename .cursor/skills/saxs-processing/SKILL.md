...
Subskills live as ordinary markdown under `saxs-processing/<name>/<name>.md`. Only this orchestrator is a Cursor Agent Skill; open linked procedure docs when you need a step’s contract.
...
- [`subtract/subtract.md`](subtract/subtract.md) (`autosaxs subtract`) — SAXS / small-angle x-ray scattering: subtract a buffer curve from a sample 1D profile (background subtraction).
...
- Generated by `autosaxs get-skills` (autosaxs 3.6.0).
