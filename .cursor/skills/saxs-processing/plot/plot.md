...
- You want to run `autosaxs plot` on SAXS data.
...
2. Run **`/path/to/myenv/bin/autosaxs plot …`** (or `autosaxs plot …` when the right env is active), or call the Python function.
