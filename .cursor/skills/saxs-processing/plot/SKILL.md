---
name: plot
description: SAXS / small-angle x-ray scattering: generate standard diagnostic plots for a 1D curve (Guinier, Kratky, log-log):
catalog-hidden: true
---
...
This skill wraps the `autosaxs plot` CLI command / `autosaxs.skill.plot` Python entry point.
