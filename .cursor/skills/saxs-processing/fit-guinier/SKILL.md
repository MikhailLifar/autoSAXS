---
name: fit-guinier
description: SAXS / small-angle x-ray scattering: fit the Guinier region on a 1D profile (adaptive Rg, I(0), Rg span). Writes:
catalog-hidden: true
---
...
This skill wraps the `autosaxs fit-guinier` CLI command / `autosaxs.skill.fit_guinier` Python entry point.
