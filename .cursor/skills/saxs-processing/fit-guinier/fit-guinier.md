...
- You want to run `autosaxs fit-guinier` on SAXS data.
...
2. Run **`/path/to/myenv/bin/autosaxs fit-guinier …`** (or `autosaxs fit-guinier …` when the right env is active), or call the Python function.
