---
name: plot-2d
description: SAXS / small-angle x-ray scattering: render 2D SAXS TIFF image(s) to PNG using log-intensity scaling (2D detector view).
catalog-hidden: true
---
...
This skill wraps the `autosaxs plot-2d` CLI command / `autosaxs.skill.plot_2d` Python entry point.
