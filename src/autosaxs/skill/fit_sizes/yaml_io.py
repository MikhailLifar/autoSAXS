...
def _quality_handoff_block(dr_quality: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "shannon_s_max": dr_quality.get("shannon_s_max"),
        "n_shannon": dr_quality.get("n_shannon"),
        "shannon_class": dr_quality.get("shannon_class"),
        "wiggle_index": dr_quality.get("wiggle_index"),
        "wiggle_class": dr_quality.get("wiggle_class"),
        "detail_reliability_class": dr_quality.get("detail_reliability_class"),
