...
4. Start watchers for the restored **intake mode**. Files already present are baselined as **known** (not auto-queued). Revisions or new paths enqueue after stability.
